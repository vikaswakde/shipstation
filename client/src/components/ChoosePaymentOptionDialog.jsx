      ...
      <DialogContent className="bg-background text-foreground border border-border sm:max-w-[625px]">
        ...
        <AnimatePresence mode="wait">
          {!showKeyInput ? (
            ...
            >
              <div
                className="bg-card text-card-foreground p-6 rounded-lg text-center relative hover:bg-accent hover:text-accent-foreground transition-colors duration-200"
